                ...
                <div class="panel-body">
                    <form runat="server">
                        <div class="form-group">
                            ...
                            <asp:Label ID="Label4" CssClass="control-label" runat="server">nombre de nuits</asp:Label>
                            <input type="number" class="form-control" id="nbnuits" runat="server" min="1" />
                            <asp:Label ID="Label5" CssClass="control-label" runat="server">nombre de chambres</asp:Label>
                            <input type="number" class="form-control" id="nbchambres" runat="server" max="4" min="1" />
                            <br />
